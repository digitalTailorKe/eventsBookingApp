  ...
  return (
    <div className="bg-slate-300 dark:bg-[#421c7a] dark:text-white min-h-screen">
      ...
      <div className="flex-col container w-full lg:max-w-screen-lg lg:mx-auto px-2 md:px-0 flex gap-4 md:flex-row">
        <div className="bg-[#fff] w-full p-5 dark:bg-[#8449dc] dark:text-white min-h-full mt-3 rounded-2xl">
          {/* Registration Component */}
          <Registration />
        </div>

        <div className="bg-[#fff] w-full p-5 m-0 md:mt-3 dark:bg-[#8449dc] dark:text-white min-h-full rounded-2xl">
          {/* Location Component */}
          <Location />
        </div>
      </div>
